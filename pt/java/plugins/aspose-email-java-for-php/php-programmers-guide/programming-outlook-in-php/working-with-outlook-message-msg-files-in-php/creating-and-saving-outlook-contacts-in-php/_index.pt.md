---
title: "Criando e Salvando Contatos do Outlook em PHP"
url: /pt/java/creating-and-saving-outlook-contacts-in-php/
weight: 10
type: docs
---

## **Aspose.Email - Criando e Salvando Contatos do Outlook**
Para criar contatos do Outlook usando **Aspose.Email Java para PHP**, basta invocar o módulo **CreateOutlookContact**. Aqui você pode ver um exemplo de código.
...
$telephone->setCallbackTelephoneNumber("(831) 758-7321 (Após horas)");
...
\# Defina as informações de email usando MapiContactElectronicAddress e MapiContactElectronicAddressPropertySet
...
print "Contato do Outlook criado com sucesso.".PHP_EOL;
