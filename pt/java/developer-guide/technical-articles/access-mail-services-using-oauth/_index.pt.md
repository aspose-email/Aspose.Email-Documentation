...
2. Fornecer uma implementação personalizada do provedor de token com base na interface [ITokenProvider](https://reference.aspose.com/email/java/com.aspose.email/itokenprovider) no construtor do cliente de email. Nesse caso, o cliente verifica o tempo de expiração do token e solicita ao [ITokenProvider](https://reference.aspose.com/email/java/com.aspose.email/itokenprovider) um novo token de acesso quando o anterior expira. Dessa forma, o cliente atualiza os tokens periodicamente e pode trabalhar com o servidor por tempo ilimitado. Muitas vezes, os serviços suportam uma maneira simples de atualizar tokens de acesso. Por exemplo, usar tokens de atualização em serviços do Google ou o fluxo de autenticação ROPC na plataforma de identidade da Microsoft pode ser usado para implementar o provedor de token.
...
Os seguintes exemplos de código mostram como se conectar aos serviços de email usando tokens de acesso.
...
Os seguintes exemplos de código mostram como se conectar aos serviços de email usando um provedor de token.
...
/**
 * <p>
 * Provedor de token de credenciais de proprietário de recurso do Azure (ROPC)
 * https://docs.microsoft.com/en-us/azure/active-directory/develop/v2-oauth-ropc
 * https://docs.microsoft.com/en-us/exchange/client-developer/exchange-web-services/how-to-authenticate-an-ews-application-by-using-oauth
 * https://portal.azure.com
 * https://developer.microsoft.com/en-us/graph/graph-explorer/#
 * parser de token https://jwt.io
 * </p>
 */
...
Os próximos exemplos de código mostram como se conectar aos serviços do Office 365 usando o provedor de token personalizado.
