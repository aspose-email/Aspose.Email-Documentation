...
{{% alert color="primary" %}}
Используйте фильтрацию на основе [критериев поиска](https://docs.aspose.com/email/net/working-with-messages-in-a-pst-file/#searching-messages-and-folders-in-pst) для получения нужных сообщений.
{{% /alert %}}
...
{{% alert color="primary" %}}
Предпочитайте массовые методы для [добавления](https://docs.aspose.com/email/net/working-with-messages-in-a-pst-file/#adding-bulk-messages) или [удаления](https://docs.aspose.com/email/net/working-with-messages-in-a-pst-file/#delete-items-in-bulk-from-pst-file) нескольких элементов.
{{% /alert %}}