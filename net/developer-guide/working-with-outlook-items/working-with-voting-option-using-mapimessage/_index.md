...
The following code snippet shows you how to Read Voting Options from a [MapiMesasge](https://reference.aspose.com/email/net/aspose.email.mapi/mapimessage).
